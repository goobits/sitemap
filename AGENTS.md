...
- **Primary stack:** TypeScript 6 + vitest + svelte-check (for the `/ui` subpath). No runtime dependencies. Optional peer-deps: `@lucide/svelte`, `@sveltejs/kit ^2`, `svelte ^5` (only needed for the `/ui` subpath), `typescript ^5 || ^6`.
